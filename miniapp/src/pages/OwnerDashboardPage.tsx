      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: "13px", color: "hsl(var(--text-hint-hsl))" }}>
            Promote users to managers or deactivate active staff members.
          </p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          <h3 style={{ fontSize: "14px", fontWeight: 700, color: "hsl(var(--text-hint-hsl))", letterSpacing: "0.05em" }}>
            ACTIVE STAFF MEMBERS ({managers.length})
          </h3>
          ...
          {loading && managers.length === 0 ? (
            ...
            <EmptyState
              title="No Managers Configured"
              description="There are no active managers in the system. Use the promotion list below to assign a manager role."
            />
          ) : (
                  ...
                  >
                          ...
                          {m.status === "active" ? (
                            confirmDisableId === m.telegram_user_id ? (
                              <div style={{ display: "flex", gap: "6px" }}>
                                ...
                                >
                                  {submittingId === m.telegram_user_id ? "..." : "Confirm"}
                                </button>
                                <button
                            ...
                            >
                              {submittingId === m.telegram_user_id ? "..." : "Activate"}
                            </button>
                          )}
                        </div>
                      )}
                    ...
                    >
                      <div style={{ display: "flex", gap: "12px", color: "hsl(var(--text-hint-hsl))" }}>
                        <span>
                          Claimed: <b>{mStats ? mStats.tickets_claimed : 0}</b>
                        </span>
                        <span>
                          Closed: <b>{mStats ? mStats.tickets_closed : 0}</b>
                        </span>
                      </div>
                      {m.notes && (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "10px" }}>
          ...
          {loading && botUsers.length === 0 ? (
            ...
            >
              No users match search criteria or have interacted with the bot.
            </div>
          ) : (
                  ...
                  >
                    ...
                    {showPromoteForm === u.telegram_user_id && (
                      ...
                      >
                        <input
                          type="text"
                          placeholder="Optional notes (e.g. name of branch)..."
                          value={promoteNotes}
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "10px" }}>
        ...
        >
          ...
          <span style={{ fontSize: "12px", fontWeight: 600, color: "hsl(var(--accent-hsl))" }}>Manage Staff Roles →</span>
        </div>
